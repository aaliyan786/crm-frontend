...
// import EditDrawer from "./LossEditDrawer";
// import RecordPaymentDrawer from "./recordPaymentDrawer";
// import PdfDrawer from "./LossPdfDrawer";
import AcceptedShowDrawer from "./AcceptedShowDrawer";
// import LossEditDrawer from "./LossEditDrawer";

const AcceptedDrawers = ({
  isOpen,
  onClose,
  drawerType,
  data,
  ...
  const renderDrawer = () => {
    switch (drawerType) {
      case "show":
        return <AcceptedShowDrawer data={data} onClose={onClose} />;
      // case "edit":
      //   return (
      //     <LossEditDrawer
...
export default AcceptedDrawers;
