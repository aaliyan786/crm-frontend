...
const RejectedQuoteList = ({ quotes, handleAddUpdateDeleteQuote }) => {
  console.log("----------------------", quotes);
  ...
  const handleAcceptQuote = async (quoteId) => {
    try {
      await acceptRejectQuote(quoteId, true); // Call the API to accept the quote
      toast({
  ...
  const handleRejectQuote = async (quoteId) => {
    try {
      await acceptRejectQuote(quoteId, false); // Call the API to reject the quote
      toast({
...
export default RejectedQuoteList;
